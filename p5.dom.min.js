...
!(function (t, e) {
  ...
  (d.prototype.select = function (t, e) {
    ...
    return (i =
      "." === t[0]
        ? ((t = t.slice(1)),
          (i = n.getElementsByClassName(t)).length ? i[0] : null)
        : "#" === t[0]
      ...
      return (
        (i.checked = function () {
          return 0 === arguments.length
            ? this.elt.checked
            : (arguments[0] ? (this.elt.checked = !0) : (this.elt.checked = !1),
              this);
        }),
        i
      );
    ...
    (d.prototype.removeElements = function (t) {
      ...
      for (var e = 0; e < this._elements.length; e++)
        this._elements[e].elt instanceof HTMLCanvasElement ||
      ...
      r.addEventListener("loadedmetadata", function () {
        (a.width = r.videoWidth),
          ...
          a.presetPlaybackRate &&
            ((a.elt.playbackRate = a.presetPlaybackRate),
  ...
  ["div", "p", "span"].forEach(function (i) {
    ...
    (d.prototype.createRadio = function (t) {
      ...
      if (1 < e.length)
        for (
          var i = e.length, s = e[0].name, l = e[1].name, a = (o = 1);
          a < i;
          a++
        )
          s !== (l = e[a].name) && o++, (s = l);
    ...
    (d.prototype.createVideo = function (t, e) {
      return (
        d._validateParameters("createVideo", arguments), i(this, "video", t, e)
      );
    }),
    (d.prototype.createAudio = function (t, e) {
      return (
        d._validateParameters("createAudio", arguments), i(this, "audio", t, e)
      );
    }),
    ...
    (d.prototype.createCapture = function () {
      ...
      return (
        ...
        o.addEventListener("loadedmetadata", function () {
          o.play(),
            o.width
              ? ((s.width = o.videoWidth = o.width),
                (s.height = o.videoHeight = o.height))
              : ((s.width = s.elt.width = o.videoWidth),
    ...
    (d.Element.prototype.toggleClass = function (t) {
      return (
        this.elt.classList.contains(t)
          ? this.elt.classList.remove(t)
    ...
    (d.Element.prototype.size = function (t, e) {
      ...
      if (i !== r || n !== r) {
        if (
          ...
          for (o in l) s[o] = l[o];
          for (o in (this.elt.setAttribute(
            "width",
    ...
    (d.MediaElement.prototype.get = function () {
      return (
        this._ensureCanvas(), d.Renderer2D.prototype.get.apply(this, arguments)
      );
    }),
